...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    // "game layer", mods on right thumb, no windows key. My left hand is on the mouse.
  ...
  // add home row mods, replaces right thumb cluster w/ layers
  [MODS] = LAYOUT_split_3x5_3(
      ...
      // Why have this when it's just an alias for RALT?
      _______, ALGR_T(KC_X), _______, _______, _______, _______, _______, _______, ALGR_T(KC_DOT), _______,
      _______, _______, _______, LT(SYM, KC_ENT), LT(NUM, KC_BSPC), LT(FN, KC_DEL)
      ),
  [NUM] = LAYOUT_split_3x5_3(
      KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_LBRC, KC_RBRC, KC_7,    KC_8,    KC_9, KC_MINUS,
  ...
  [FN] = LAYOUT_split_3x5_3(
    RESET,   KC_NO,   KC_NO,   KC_NO,    KC_NO,  KC_F12,  KC_F7,   KC_F8,   KC_F9,   KC_PSCR,
    KC_NO,   KC_NO,   KC_NO,   TG(MODS), KC_NO,  KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_SLCK,
    DEBUG,   KC_ALGR, KC_NO,   KC_NO,    KC_NO,  KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_PAUS,
